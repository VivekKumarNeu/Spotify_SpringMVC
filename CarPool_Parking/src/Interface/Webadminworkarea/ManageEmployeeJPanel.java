...
//        for (Person per : organization.getPersondirectory().personList){
//            Object[] row = new Object[2];
//            row[0] = per.getGender();
//            row[1] = per.getPersonName();
//            model.addRow(row);
//        }
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        boolean ifexist =organization.getEmployeeDirectory().searchEmployee(name);

        if(!ifexist)
            organization.getEmployeeDirectory().createEmployee(name);
        else
            JOptionPane.showMessageDialog(this, "Name already exist.Please select a different name","Error",JOptionPane.ERROR_MESSAGE);
