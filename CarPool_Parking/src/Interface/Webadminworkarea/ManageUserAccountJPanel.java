...
public class ManageUserAccountJPanel extends javax.swing.JPanel {
    ...
    public void popOrganizationComboBox() {
        ...
        for (Organization organization : enterprise.getOrganizationDirectory().getOrganizationList()) {
             if(organization.getName().equals("Car Owner Organization") || organization.getName().equals("Caruser Organization"))
            {}else
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                            ...
                                            .addComponent(roleJComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 225, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void createUserJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createUserJButtonActionPerformed
            ...
            for(Network network : system.getNetworkList())
                for(Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList())
                  for(Organization org : enterprise.getOrganizationDirectory().getOrganizationList()){
                      statusx = org.getUserAccountDirectory().checkIfUsernameIsUnique(nameJTextField.getText());
                         if(statusx){                        
                         }else{
                            statusx=false;
        ...
        if(role.toString().equals("Business.Role.TechnicalRole"))
        {
            for (Organization oo : enterprise.getOrganizationDirectory().getOrganizationList())
                    if(oo.toString().equals("TechnicalPersonOrganization"))
                       {
                           for(Role rolee : oo.getSupportedRole())
                               oo.getUserAccountDirectory().createUserAccount(userName, password, employee, null, rolee);
                       }
        }
